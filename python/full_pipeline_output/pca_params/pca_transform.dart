...
class PCATransform {
  ...
  static final List<double> mean = [
    -0.013803, -0.007072, 0.034905, 0.007253, -0.007504, 0.009974, -0.009355, -0.005958, 0.009884, 0.008746,
    // ... 374 more values
  ];
  
  // Transformation matrix (components or whitening matrix)
  static final List<List<double>> transformMatrix = [
    [-0.104300, 0.090145, 0.133198, -0.138666, 0.028372, /* ... 379 more values */],
    [-0.092811, -0.020006, -0.171275, -0.014348, -0.114708, /* ... 379 more values */],
    [0.062292, -0.110130, -0.049796, -0.273441, -0.146171, /* ... 379 more values */],
    // ... 20 more rows
  ];
